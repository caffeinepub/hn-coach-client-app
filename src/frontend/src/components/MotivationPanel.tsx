...
export default function MotivationPanel({
  ...
  return (
    <div
      className={`rounded-2xl border border-blue-200 shadow-md p-4 transition-all duration-350 ${
    ...
    >
      ...
      <div className="flex gap-2 flex-wrap">
        <span className="text-xs bg-green-700/20 text-green-400 px-2 py-1 rounded-full">
          💪 Exercise
        </span>
